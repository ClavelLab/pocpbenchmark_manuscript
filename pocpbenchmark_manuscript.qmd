...
- The BLASTPDB approach is a strong contender because whilst using more resources, it performs exactly the same as BLASTP (@suppfig-blastdb) in a fraction of the time (@tbl-tools-metrics).
- Still, 
- DIAMOND still performs 10 times faster than BLASTDB and in less than 4% (change wording here) of the time.
- TODO: include exact R2 value to compare DIADMONDFAST and very sensititve?
