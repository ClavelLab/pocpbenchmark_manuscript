...
For all tools, two clusters of yellow points are visible (@fig-blast-vs-all-pocpu). They indicate regions where at least 50% of the data points are located, with the first and second regions being below and above 50% on the x-axis BLASTP POCPu, respectively. 
...
We set out to evaluate whether the POCP (or POCPu) with a threshold of 50% is a useful in delineating bacterial genus.
